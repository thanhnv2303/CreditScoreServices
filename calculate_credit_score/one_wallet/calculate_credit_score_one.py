...
def get_tscore(value, mean, std):
    z_score = (int(value) - int(mean))/int(std)
...
class CalculateCreditScoreOneWallet:
    ...
    def calculate_x134(self):
        ...
        #x3 = 0
        #x4 = 0
        total_asset_average = calculate_average_second(balanceChangeLogValues, balanceChangeLogTimestamps, self.time)
